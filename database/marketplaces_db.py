...
# ============================================================
# BUSCAR PEDIDO MARKETPLACE POR VENDA ERP
#
# Uso principal:
# - identificar se uma venda nasceu de marketplace;
# - disponibilizar os valores comerciais do marketplace
#   para composicao fiscal;
